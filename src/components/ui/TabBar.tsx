...
import { StyleProp, ViewStyle, TextStyle, PressableAndroidRippleConfig, View, Animated, Platform, I18nManager, FlatList, useAnimatedValue, LayoutChangeEvent, ListRenderItemInfo, ViewToken, StyleSheet } from "react-native";
import { Route, SceneRendererProps, NavigationState, TabBarItemProps, TabBarIndicator, TabBarItem } from "react-native-tab-view";
import { Props as IndicatorProps } from "../../../node_modules/react-native-tab-view/src/TabBarIndicator"
import { Scene, Layout } from "react-native-tab-view/lib/typescript/src/types";
